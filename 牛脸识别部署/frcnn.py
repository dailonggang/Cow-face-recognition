...
class myClass(object):
    ...
    def __init__(self, atiou, images):
        self.atiou = atiou
        self.images = images
...
class FRCNN(object):
    _defaults = {
        "model_path": 'logs/Epoch100-Total_Loss0.1438-Val_Loss0.2613.pth',
    ...
    def detect_image(self, image):
        ...
        for i, c in enumerate(label):
            ...
            atiou = [label, top, left, bottom, right]
